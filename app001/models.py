...
class LYKJSYS(models.Model):
    ...
    time_L = models.DateField(verbose_name='时间',auto_now_add=True,)
    #time_L = models.DateTimeField.auto_creation_counter(verbose_name='时间')
    #time_L = models.DateTimeField(verbose_name='时间',)
